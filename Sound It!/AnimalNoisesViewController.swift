...
class AnimalNoisesViewController: UITableViewController {
    ...
    var noises = SomeData.generateAnimalNoiseData() // retrieves data from class generateNoiseData from file SomeData
    
}

extension AnimalNoisesViewController {
